...
get_gui(){
    wget https://github.com/txthinking/nami/releases/latest/download/Brook.dmg
    wget https://github.com/txthinking/nami/releases/latest/download/BrookLite.exe
    # wget https://github.com/txthinking/nami/releases/latest/download/
    # wget https://github.com/txthinking/nami/releases/latest/download/
}
